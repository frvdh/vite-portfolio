...
import HeroImage from '../assets/signalMeme.png'
  ...
  return (
    <div className='bg-black text-white text-center py-16'>
      ...
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>François Vanderheeren</span>
        , Software engineer and DJ
      </h1>
      <p className='mt-4 text-lg text-gray-300'>
        I'm a software developer and DJ based in Belgium. I create web applications and mix music.
      </p>
